...
def parse_args(args: [str] = None) -> Namespace:
    ...
    parser.add_argument('--model', type=str, default='ssd_mobilenet_v2_coco_2018_03_29', help='TensorFlow model name from TensorFlow Detection Model Zoo (default: ssd_mobilenet_v2_coco_2018_03_29). For the list of TensorFlow Model Zoo out-of-the-box models, see https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/detection_model_zoo.md')
    parser.add_argument('--skip-frames', type=int, default=0, help='Number of frames to skip. Useful if frame rate is too high. Note, if --videopath is not set, the detector automatically skips frames if necessary for real time analysis (default: 0)')
